...
http_archive(
    ...
    sha256 = "83a3e094be70978cd843778a3214268714e077343fd9a5baacad31dd420304c3",
    strip_prefix = "grpc-java-1.45.0",
    url = "https://github.com/grpc/grpc-java/archive/v1.45.0.tar.gz",
)
